...
class FUNITModel(ModelBase):
    ...
    def onInitialize(self, batch_size=-1, **in_options):
        ...
        #self.GA = modelify(FUNITModel.ResNet (bgr_shape[2], use_batch_norm, n_blocks=6, ngf=ngf))( Input(bgr_shape) )
        #self.GB = modelify(FUNITModel.ResNet (bgr_shape[2], use_batch_norm, n_blocks=6, ngf=ngf))( Input(bgr_shape) )
        ...
        #self.DA = modelify(FUNITModel.PatchDiscriminator(ndf=ndf) ) ( Input(bgr_shape) )
        #self.DB = modelify(FUNITModel.PatchDiscriminator(ndf=ndf) ) ( Input(bgr_shape) )
