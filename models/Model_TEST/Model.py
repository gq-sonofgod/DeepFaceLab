...
class TrueFaceModel(ModelBase):
    ...
    def onInitializeOptions(self, is_first_run, ask_override):
        default_face_type = 'f'
        if is_first_run:
            self.options['resolution'] = io.input_int("Resolution ( 128,224 ?:help skip:224) : ", 224, [128,224])
        else:
            self.options['resolution'] = self.options.get('resolution', 224)
    ...
    def onInitialize(self, batch_size=-1, **in_options):
        ...
        self.model = FUNIT( face_type_str='mark_only', 
